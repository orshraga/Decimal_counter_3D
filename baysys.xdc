...
set_property PACKAGE_PIN V16 [get_ports {TOP_COUNT[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {TOP_COUNT[0]}]
set_property PACKAGE_PIN W16 [get_ports {TOP_COUNT[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {TOP_COUNT[1]}]
set_property PACKAGE_PIN W17 [get_ports {TOP_COUNT[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {TOP_COUNT[2]}]
set_property PACKAGE_PIN W15 [get_ports {TOP_COUNT[3]}]					
...
set_property PACKAGE_PIN W3 [get_ports {Led}]					
